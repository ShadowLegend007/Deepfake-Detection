  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isCompleted && (
          <div className={`px-4 pb-4 sm:px-6 sm:pb-6 ${footerClassName}`}>
            <div className={`mt-6 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full bg-blue-500 py-2 px-6 font-medium tracking-tight text-white transition hover:bg-blue-600 active:bg-blue-700"
                {...nextButtonProps}
              >
    ...
    >
      <motion.div
        ...
        className={`flex h-8 w-8 items-center justify-center rounded-full font-semibold transition-colors duration-300 ${
          status === 'inactive'
            ? 'bg-blue-100 text-blue-500 dark:bg-neutral-800 dark:text-neutral-400'
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: 'var(--step-complete-bg, #3b82f6)' }
  };

  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-blue-100 dark:bg-neutral-800">
      <motion.div
